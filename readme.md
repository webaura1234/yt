...
| File                                                                                            | Summary                                                                                                                                                                                                                                                                              |
| ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [config.py](https://github.com/marvinvr/auto-yt-shorts/blob/master/config.py)                   | Defines the target audience (Telugu, ages 5-12), the kid-safe learning areas in `POSSIBLE_TOPICS`, the made-for-kids upload declaration, model selection, and API keys. Creates directories for temporary files, output, background songs, and the cartoon artwork cache.        |
